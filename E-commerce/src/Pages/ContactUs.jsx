...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2">
          ...
          <form className="space-y-6">
            ...
            <button className="bg-[#4A2D1A] text-white px-8 py-4 rounded-sm text-sm font-bold hover:bg-[#cebdb5] hover:text-black  transition-colors uppercase tracking-widest">
              Send Message
            </button>
          </form>
        </div>
      ...
      {/* Map Section */}
      <div className="w-full h-112 bg-gray-100 relative grayscale opacity-70">
        <iframe
          title="location-map"
