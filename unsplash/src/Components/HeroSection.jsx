      ...
      <section className='flex items-end justify-center w-full '>
       {/* Introduction */}
        <div className=' w-1/2 overflow-hidden px-6'>
            <h1 className='text-[40px] font-bold'>Unplash</h1>
            <p className='my-2 text-[18px] font-normal'>This Internet&apos;s source for visuals.
                <br />
       ...
       {/* Card */}
        <div className='w-1/2 border border-gray-300 rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl '>
        {/* text-btn */}
        <div className='w-1/2 flex flex-col justify-end items-start gap-y-25'>
            <div> 
              ...
              {/* text */}
              <p className='text-[15px] font-semibold leading-normal my-2'>Create confidentntly with
                <br />
                enhanced legal protection.
              </p>
              <p className='text-[15px] font-semibold leading-normal text-[#767676] my-2'>Primume downloads
                <br />
                back by full coverage.
              </p>
        ...
        <div className='relative w-1/2'>
            <img src="https://unsplash-assets.imgix.net/modules/legal-protections/photo-1.jpg?w=192&dpr=1&h=257&auto=format&fit=crop&q=60" alt="" className='-rotate-6'/>
            ...
            {/* chip-1 */}
         <div className='flex items-center justify-center gap-x-1 absolute z-10 top-32 left-18 text-[12px] border border-gray-200 rounded-full px-2 py-1 bg-white '><CircleCheck fill="green" className='text-white w-5 h-5'/>Worry-free Licensing</div>
         {/* chip-2 */}
         <div className='flex items-center justify-center gap-x-1 absolute z-10 text-[12px] border border-gray-200 rounded-full px-2 py-1 bg-white top-44 -left-6'><CircleCheck fill="green" className='text-white w-5 h-5'/>Cleared for all uses</div>
         {/* sign */}
